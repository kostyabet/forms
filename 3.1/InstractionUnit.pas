...
Begin
    ...
    #13#10 + '   Коэффициент K находится в пределах [1..40];' + 
    ...
    #13#10 + 'Каждый эллемент с новой строки!' + 
    #13#10 + '*Файл должен быть строго формата .txt!!!*' + #13#10 +
    #13#10 + 'Если номер вхождения больше длины строки,' + 
    #13#10 + 'это равносильно ситуации, когда такого' + 
    #13#10 + 'вхождения нет.';
End;
