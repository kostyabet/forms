...
Begin
    ...
    #13#10 + '2. К находится в пределах от [1;9999];' + 
    #13#10 + '3. После того, как вы ввели К,' + 
    #13#10 + '   нажимайте кнопку ''рассчитать''.' + #13#10 + 
    #13#10 + 'Дополнительные инструкции для файла:' +
    #13#10 + '1. В файле первым идёт сразу число K.' + 
